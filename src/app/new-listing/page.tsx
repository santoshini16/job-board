    ...
    return(
        <div className="container">
                <div className="text-white">
                     ...
                     <p className=" text-sm mb-2">Select a company to create a job add for</p>
                     
                     <div>
                        <div className="border inline-block rounded-md mb-1">
                    ...
                    <Link
                        className="inline-flex gap-2 items-center bg-amber-600 px-4 py-2 rounded-md mt-6"
                        href={'/new-company'}>
