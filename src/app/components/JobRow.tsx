...
export default function JobRow({jobDoc}:{jobDoc:Job}) {
  return (
    <>
      <div className="bg-amber-500 p-4 rounded-lg shadow-slate-100 shadow-md relative">
        ...
        <div className="flex grow gap-4">
          <div className="content-center w-12 basis-12 shrink-0">
            <img
              className="size-12"
              src="https://img.freepik.com/premium-photo/poster-company-company-with-word-company-it_1115474-114758.jpg" alt=""/>
          </div>
          <div className="grow sm:flex">
            <div className="grow">
              <div>
                <Link href={`/jobs/${jobDoc.orgId}`} className="hover:underline text-gray-100 text-sm">{jobDoc.orgName || '?'}</Link>
              </div>
